 ...
 */
public class EditPatientCommand extends ClinicCommand {
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_EDIT_PERSON_SUCCESS, ClinicMessages.format(editedPerson)));
    }
