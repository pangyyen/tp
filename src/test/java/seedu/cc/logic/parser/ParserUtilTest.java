...
import static seedu.cc.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    private static final String INVALID_TAG = "#Hypertension";

    private static final String VALID_NAME = "Rachel Walker";
    private static final String VALID_PHONE = "12345600";
    private static final String VALID_AGE = "5";
    private static final String VALID_EMAIL = "rachel@example.com";
    private static final String VALID_TAG_1 = "Hypertension";
    private static final String VALID_TAG_2 = "Asthma";
