...
|------------------------------|---------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| **Add Patient**              | `add-patient n/NAME ic/NRIC a/AGE p/PHONE_NUMBER e/email [t/TAG]…`                                            | e.g., `add-patient n/John Doe ic/S0123456A a/45 p/12341234`     |
...
| **Edit Medical History**     | `edit-medical-history MEDICAL_HISTORY_INDEX [pi/PATIENT_INDEX] [d/DATE] [mc/MEDICAL_CONDITION] [t/TREATMENT]` | e.g., `edit-medical-history 1 pi/1`                             |
